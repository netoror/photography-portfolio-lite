// ==================== 作品集数据（全部使用版本 A 的原始图片） ====================
const portfolioData = [
    { id: 1, title: "京都美术馆大厅", category: "城市摄影", image: "../versions/a-version/images/gallery.jpg", fullImage: "../versions/a-version/images/gallery.jpg", description:"京都美术馆大厅，平整、洁白、对称。。。", likes: 0 },
    { id: 2, title: "天空之门", category: "城市摄影", image: "../versions/a-version/images/sky_door.jpg", fullImage: "../versions/a-version/images/sky_door.jpg", description:"京都美术馆门口的巨大鸟居", likes: 0 },
    { id: 3, title: "前往大阪某大型超市的路上的随手一拍", category: "城市摄影", image: "../versions/a-version/images/osaka_road.jpg", fullImage: "../versions/a-version/images/osaka_road.jpg", description:"莫名其妙地决定前往当地一家大型超市。走在路上", likes: 0 },
