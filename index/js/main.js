...
const portfolioData = [
    ...
    { id: 7, title: "大阪某大型平价超市门口街景 1", category: "城市摄影", image: "./images/osaka_outside_supermarket1.jpg", fullImage: "./images/osaka_outside_supermarket1.jpg", description:"渴了，喝水", likes: 0 },	
    { id: 8, title: "9 点来钟在大阪某 jr 站里，准备前往难波区的 bic camera 买 kindle", category: "城市摄影", image: "./images/a_jr_station_at_osaka_night.jpg", fullImage: "./images/a_jr_station_at_osaka_night.jpg", description:"十点来钟的电车站，几乎没有人，心里毛毛地。。。", likes: 0 },
];
...
function initGallery() {
    ...
    portfolioData.forEach((photo, i) => {
        ...
        likeBtn.onclick = (e) => {
            e.stopPropagation();  // ✅ 阻止冒泡到 gallery-item
            addLike(photo.id);
        };
...
document.addEventListener('DOMContentLoaded', () => {
    loadLikesFromStorage();  // ✅ 先加载 LocalStorage 中的点赞数据
    initGallery();           // ✅ 然后用最新的点赞数渲染画廊
    initSmoothScroll();
    initObserver();
